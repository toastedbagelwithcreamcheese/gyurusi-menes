...
const pages=[["/","home"],["/turak","turak"],["/egyesulet","egyesulet"],["/esemenyek","esemenyek"],["/esemenyek/lovasnapok-2026","esemeny"],["/en","home-en"],["/admin","admin"],["/admin/oldalak/turak","admin-oldal"]];
const report=[];
