...
## Corpus Check
- 163 files · ~366,625 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1284 nodes · 3070 edges · 74 communities (63 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cd62d308`
...
Cohesion: 0.07
Nodes (69): dynamic, POST(), dynamic, POST(), dynamic, POST(), dynamic, FORMATS (+61 more)
...
Cohesion: 0.09
Nodes (34): PagesAdmin(), P, revalidate, Photo(), photoAlt(), PhotoKey, PhotoMeta, PHOTOS (+26 more)
...
Cohesion: 0.10
Nodes (32): dynamic, sitemap(), ContactForm(), State, Header(), KEYS, LangMenu(), LangSwitch() (+24 more)
...
### Community 24 - "t"
Cohesion: 0.15
Nodes (25): EventsAdmin(), persons(), RegistrationsAdmin(), AdminHome(), dynamic, GET(), dynamic, GET() (+17 more)
...
Cohesion: 0.09
Nodes (42): dynamic, GET(), dynamic, POST(), lockedMessage(), login(), LoginState, logout() (+34 more)
...
Cohesion: 0.16
Nodes (9): fraunces, instrument, Params, RootLayout(), BOTS, DISALLOW, RevealObserver(), ScrollTop() (+1 more)
...
Cohesion: 0.13
Nodes (21): EventsPage(), P, revalidate, Labels, MapEmbed(), ContactBlock(), EventGrid(), EventList() (+13 more)

### Community 35 - "google-reviews.ts"
Cohesion: 0.08
Nodes (26): dynamic, HEADERS, Labels, Reviews(), State, apiBase(), Counter, dailyCap() (+18 more)
...
### Community 37 - "seo.ts"
Cohesion: 0.13
Nodes (30): backdrop(), FONT, FULL, GET(), titleSize(), absUrl(), brandTitle(), breadcrumbLd() (+22 more)
...
Cohesion: 0.19
Nodes (20): config, dailyMaintenance(), Backup, backupDir(), backupStore(), budapestDay(), claimRun(), LastRun (+12 more)
...
Cohesion: 0.10
Nodes (33): GET(), generateMetadata(), P, PrivacyPage(), revalidate, EventPage(), generateMetadata(), generateMetadata() (+25 more)
...
Cohesion: 0.20
Nodes (18): POST(), POST(), apiBase(), CONFIRM, contactRecipient(), DEFAULT_CONTACT_TO, DEFAULT_FROM, endpoint() (+10 more)
...
Cohesion: 0.28
Nodes (14): clientIp(), Entry, evaluate(), hit(), HitResult, ipKey(), limitByIp(), peek() (+6 more)

### Community 67 - "p2-uploads.mjs"
Cohesion: 0.16
Nodes (9): parallelSaves(), CheckError, chromeExe, dbReset(), BASE, cleanups, noisyJpeg(), pdfFixture() (+1 more)

### Community 68 - "[slug]/page.tsx"
Cohesion: 0.19
Nodes (11): PageEdit(), ContentPage(), fmtSize(), P, revalidate, CONTOURS, FORESTS, RouteMap() (+3 more)

### Community 69 - "blobsAvailable"
Cohesion: 0.42
Nodes (12): assembleChunks(), blobKey(), CHUNK_RETENTION_MS, ChunkManifest, deleteChunks(), localDir(), pruneStaleChunks(), putChunk() (+4 more)

### Community 70 - "(panel)/layout.tsx"
Cohesion: 0.24
Nodes (8): Flash(), RegTable(), AdminLayout(), dynamic, MessagesAdmin(), maybeRunMaintenance(), listMessages(), formatDateTime()
...
Cohesion: 0.29
Nodes (6): 1. Kiinduló állapot, 2. Kódváltozások ebben a fázisban, 3. final-live.mjs (G28) helyi próbája, 4. Teljes kapusor, 5. Az éles tár mellékhatása (G13), Ellenőrzés fázis — teljes kapusor helyben, a G28 előkészítése
...
## Knowledge Gaps
- **436 isolated node(s):** `eslintConfig`, `config`, `LEGACY`, `nextConfig`, `name` (+431 more)
...
- **Why does `readSite()` connect `readSite` to `records.ts`, `Sections.tsx`, `store.ts`, `[slug]/page.tsx`, `seo.ts`, `(panel)/layout.tsx`, `SubPage.tsx`, `blobsAvailable`, `types.ts`, `t`, `maintenance.ts`, `admin-auth.ts`, `register/route.ts`?**
