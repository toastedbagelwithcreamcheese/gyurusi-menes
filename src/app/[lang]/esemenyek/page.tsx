...
import { EventCard, EventList } from "@/components/site/Sections";
  ...
  return (
    <Shell site={site} lang={lang} d={d} rest="/esemenyek">
      ...
      <div className="wrap">
        ...
        {up.length > 0 && <Reveal className="ev-section"><p className="eyebrow" style={{ marginBottom: 12 }}>{d.events.upcoming}</p><EventList list={up} lang={lang} d={d} /></Reveal>}
