...
export const hu: Dictionary = {
  ...
  reviews: { eyebrow: "Ezt mondják rólunk", title: "Google-értékelések", count: "{n} értékelés a Google-on", more: "Összes értékelés a Google-on", on: "a Google-on", stars: "{n} csillag az 5-ből" },
